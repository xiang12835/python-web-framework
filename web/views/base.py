...
from web.libs.keyword import keyword
...
class BaseHandler(RequestHandler):
    ...
    def keyword_filte(self, content):
        return keyword.mark_filte(content)

    def out_content(self, content):
        return keyword.output(content)
    ...
    def _deco_method(self, fn):
        def _func(*args, **kwargs):
            ...
            try:
                ...
                import traceback
                traceback.print_exc()
                return self.send_error(status_code=400, desc=str(e)+","+e.message)
        return _func

    def auth_login(self, user_id, expires_days=365*1):
    ...
    def current_user(self):
        ...
        if not hasattr(self, "_current_user"):
            ...
            try:
                user = BskUser.objects.get(user_id=user_id)
            except Exception:
                user = None
            finally:
