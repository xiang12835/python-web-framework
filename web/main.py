...
load_django_settings('python-web-framework.base', 'python-web-framework.app', 'python-web-framework.web')
...
import logging
import settings
from web.document.doc_tools import load_api_doc


def init_options():
    tornado.options.define('port', default=13000, type=int)
