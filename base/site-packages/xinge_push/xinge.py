...
class XingeApp(object):
    ...
    def ValidateMessageType(self, message):
        #print self.accessId , self.IOS_MIN_ID
        #print self.accessId >= self.IOS_MIN_ID 
        #print "d", isinstance(message, MessageIOS)
        #print "i", self.accessId < self.IOS_MIN_ID and not isinstance(message, MessageIOS)
    ...
    def PushSingleDevice(self, deviceToken, message, environment=0):
        ...
        params['device_token'] = deviceTokenf
