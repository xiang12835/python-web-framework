...
mfunc_cache = memcache.Client(memcache_settings["func_cache"])
muser_cache = memcache.Client(memcache_settings["user_cache"])
push_cache = memcache.Client(memcache_settings["push_cache"])
