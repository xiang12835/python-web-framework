              ...
              <li class="news-bd-list-li"  
                ...
                <router-link  :to="{ name: 'JobList', params: { department_id: item.department_id }}">
                    ...
                    <div class="item-fd">
                        <div class="fd-left">
                            <i class="mr5">招考人数</i>
                            <i class="mr10 bsk-color">{{item.enrolment_num}}</i>
                            <i class="mr5" v-if="item.application_num!=0">报名人数</i>
...
<script>
import { api_get_my_jobs } from "../../networks/JobList"
	...
	created: function() {
  	...
  	methods: {
  		get_myjobs() {      
			...
			var promise = api_get_my_jobs(context,pageNum,wxopenid);
