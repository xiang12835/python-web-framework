...
from py2_django.content.forms import Mybook
...
# from py2_django.learning.models import Book
# from py2_django.learning.serializers import BookSerializer
...
# 2-5-1 django自带的小缓存
from py2_django.content.models import Book
